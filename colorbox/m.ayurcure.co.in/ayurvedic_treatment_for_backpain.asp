...
<title>Ayurcure Clinic | Treatment  :: Backpain</title>
<!-- for-mobile-apps -->
								   ...
								   <div class="col-md-8 latest-news-agile-left-content">
											<div class="single video_agile_player">
										            ...
										            <div class="video-grid-single-page-agileits">
														<div data-video="f2Z65fobH2I" id="video"> <img src="images/backpain.jpg" alt="" class="img-responsive" /> </div>
													</div>
						<br> <p align="justify">Backpain is the most common pain disorder. It is a chronic condition, characterized by persistent dull or sharp pain; it may also associate with burning, stiffness, numbness or 
						tingling with the pain shooting down buttocks and legs. Pain in lower back restrict the activity and reduces work capacity and restricts day to day activities. Survey indicates that, 70% of the people 
						suffer from lower back pain at some time in their lives.
<br><br>
Back pain is pain felt in the back that usually originates from the muscles, nerves, bones, joints or other structures in the spine.Back pain may have a sudden onset or can be a chronic pain; it can be constant or 
intermittent, stay in one place or radiate to other areas. It may be a dull ache, or a sharp or piercing or burning sensation. The pain may radiate into the arms and hands as well as the legs or feet, and may include
 symptoms other than pain. These symptoms may include tingling, weakness or numbness.
<br><br>
...
<br><br>
The spine is a complex interconnecting network of nerves, joints, muscles, tendons and ligaments, all of which are capable of producing pain. Large nerves that originate in the spine and go to the legs and arms can make 
pain radiate to the extremities."

<br><br>

<b>CAUSES</b><br>
One of the common causes for the backache is poor posture habit. Lower back pain can result due to health problems like osteoporosis, scoliosis, spinal stenosis. Other possible causes include fibromyalgia and benign or 
malignant tumors. Increase in body weight can also cause lower back pain.<br><br>

<b>TREATMENT</b><br>

Treatment for lower back ache includes 2 categories :<br>
<b>1) PANCHKARMA:</b> In backache, katibasti and elakizhi is very effective treatment which reduces the pain immediately.<br>

<b>2) MEDICINES:</b> We provide a special medicine which reduces the pain very effectively and patient feels relief.<br>
