...
<head>
<title>Ayurvedic Treatment for Acidity, Acid Reflux Treatment In Ayurveda</title>
<meta name="description" content="Ayurvedic Treatment for Acidity, Acid Reflux Treatment In Ayurveda. According to Ayurveda, acid reflux is caused when the heat energy within our cells, known as Pitta, becomes imbalanced. Find out best ayurvedic solutions for this condition."/>

<meta name="keywords" content="ayurvedic treatment for acidity, acid reflux treatment In ayurveda, how to cure acidity permanently, ayurvedic medicine for acidity, ayurvedic treatment for acid reflux, ayurvedic treatment for acidity, best ayurvedic medicine for acidity, acid reflux ayurveda, ayurvedic medicine for acidity and gas,ayurvedic medicine for acidity and heartburn,ayurvedic medicine for hyperacidity, ayurvedic medicine for acid reflux, ayurvedic medicine for gas and acidity, ayurveda acid reflux, ayurvedic medicine for acidity and heartburn, GERD treatment in ayurveda, ayurvedic medicine for GERD and gastritis, ayurvedic treatment for gerd,Acid Reflux (GERD) ">
<!-- for-mobile-apps -->
								   ...
								   <div class="col-md-8 latest-news-agile-left-content">
											<div class="single video_agile_player">
										            ...
										            <div class="video-grid-single-page-agileits">
														<div data-video="f2Z65fobH2I" id="video"> <img src="images/acidity.jpg" alt="" class="img-responsive" /> </div>
													</div>
				                              <h1>Ayurvedic Treatment for Acidity, Acid Reflux Treatment In Ayurveda</h1>
				                              <h3>&nbsp;</h3>
				                              <h3>Ayurvedic Treatment for Acidity, Acid Reflux Treatment In Ayurveda.According to Ayurveda, acid reflux is caused when the heat energy within our cells, known as Pitta,becomes imbalanced. Find out best ayurvedic solutions for this condition.</h3>
				                              <h1>&nbsp;</h1>
				                              <p align="justify">Acidity is now became a common disease due to our food habit and stressful life style. Due to heavy stress or improper food habit, like consumption of junk food, heavy and fried food, spicy food, and stressful work is triggering Acidity. View More In acidity, there is more gastric juice formation than is needed. Due to excess formation of gastric juice, there is burning sensation in stomach and this causes discomfort. In Ayurveda, complete cure of acidity is possible. Medication provided for this very effectively regularizes the formation of gastric juice, and thus relieves from the disease.
						                              
  <br><br>
Acidity refers to a set of symptoms caused by an imbalance between the acid secreting mechanism of the stomach and proximal intestine and the protective mechanisms that ensure their safety. The stomach normally secretes acid that is essential in the digestive process. This acid helps in breaking down the food during digestion. When there is excess production of acid by the gastric glands of the stomach, it results in the condition known as acidity. However, there are certain types of ulcers where acid secretion is either normal or even low. Acidity is responsible for symptoms like dyspepsia, heartburn and the formation of ulcers (erosion of the lining of the stomach or intestines). Acidity tends to have a much higher incidence in highly emotional and nervous individuals. It is also more common in the developed and industrialised nations, though a recent increase in incidence has also occurred in the developing countries. Consumption of Alcohol, highly spicy foodstuffs, non-vegetarian diets, and Non Steroidal Anti-Inflammatory Drugs (NSAID's) also predispose to gastric acidity. Prevention mainly consists of avoiding the known causative factors like alcohol consumption, spicy foods, drugs like NSAID's, steroids etc. Patients with highly nervous and emotional disposition and those involved in high-stress jobs must be given psychological treatment. Avoiding non-vegetarian diets is also useful in minimising symptoms of acidity. "</p>
						<h2 id="ayurvedic_view">Ayurvedic Hyperacidity Treatment</h2>
						<div ng-bind-html="main.trustHtml(main.markdownToHtml(disease.details.ayurvedic_description))">
						  <p align="justify">Hyperacidity is known as Amlapitta in Ayurveda (Amla means sour and Pitta means heat). Hyperacidity therefore is a condition characterized by an increase of sourness and heat in the body. The aggravated Pitta impairs the digestive fire, leading to improper digestion of food and production of ama (toxins). This ama gets accumulated in the digestive channels and causes Hyperacidity.</p>
						  <p>Acidity treatment in Ayurveda is focused on pacifying the aggravated Pitta Dosha. Cleansing herbs are also administered to eliminate toxins from the body and cleanse the channels. This automatically enhances the digestive fire, leading to better digestion.</p>
						  </div>
						<div></div>
						<h2 id="diet_lifestyle_advice">Diet &amp; Lifestyle Advice</h2>
						<div></div>
						<div ng-bind-html="main.trustHtml(main.markdownToHtml(disease.details.diet_lifestyle_advice))">
						  <ul>
						    <li>
						      <p>Avoid tea, coffee, and carbonated or alcoholic beverages.</p>
					        </li>
						    <li>
						      <p>Avoid processed and fermented foods.</p>
					        </li>
						    <li>
						      <p>Avoid using garlic, ginger, onions, tomatoes, and vinegar in cooking.</p>
					        </li>
						    <li>
						      <p>Also avoid rich gravies, sour, salty, and spicy foods.</p>
					        </li>
						    <li>
						      <p>Curd should be strictly avoided at night.</p>
					        </li>
						    <li>
						      <p>Take meals in a relaxed atmosphere at regular intervals.</p>
					        </li>
						    <li>
						      <p>Practice Yoga and Pranayama such as Vajrasana, Bhujangasana, Salabhasana, Bhastrika Pranayama,Shitali Pranayama and Shitkari Pranayama.</p>
					        </li>
					      </ul>
						  </div>
						<div></div>
						<h2 ng-if="disease.details.home_remedies.length>0" id="home_remedies">Home Remedies</h2>
						<div></div>
						<ul ng-if="disease.details.home_remedies.length>0">
						  <li ng-repeat="remedy in disease.details.home_remedies" ng-bind-html="main.trustHtml(main.markdownToHtml(remedy))">
						    <p>Take powder of roasted cumin and coriander seeds (25 gm each) and mix with 50 gm of sugar. Take half spoon of it 3 times a day to get rid of hyperacidity.</p>
					      </li>
						  <li ng-repeat="remedy in disease.details.home_remedies" ng-bind-html="main.trustHtml(main.markdownToHtml(remedy))">
						    <p>Make a powdered mixture of equal parts of rock candy (or unrefined sugar), fennel, and green cardamom. Whenever you feel heartburn, mix 1 teaspoon of the mixture in a glass of cold milk and drink.</p>
					      </li>
						  <li ng-repeat="remedy in disease.details.home_remedies" ng-bind-html="main.trustHtml(main.markdownToHtml(remedy))">
						    <p>Drink 100-500 ml of tender coconut water twice a day for relief from hyperacidity Mix equal parts of powdered fennel, licorice root, basil leaves and coriander seeds. Have ½ teaspoon of this mixture with ½ teaspoon of powdered rock candy (or unrefined sugar) 15 minutes before lunch and dinner.</p>
					      </li>
						  </ul>
						<p align="justify">&nbsp;</p>
										    </div>
				...
				<div class="clearfix"> </div>
								   ...
								   <div class="col-md-4 latest-news-agile-right-conte
											...
											<ul>
                                                ...
                                                <font color="#87A817">Polycystic Ovarian Disease</font></a><font color="#87A817"><br>
												</font>
                                                ...
                                                <font color="#87A817">Ulcerative Colitis</font></a><font color="#87A817">	<br>											
											    </font>											
											</ul>
										 </div>
